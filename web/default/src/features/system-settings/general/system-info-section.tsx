  ...
  const { form, handleSubmit, handleReset, isDirty, isSubmitting } =
    useSettingsForm<SystemInfoFormValues>({
      ...
      onSubmit: async (_data, changedFields) => {
        const shouldReloadForThemeSwitch =
          'theme.frontend' in changedFields &&
          normalizeValue(changedFields['theme.frontend']) !==
        ...
        if (shouldReloadForThemeSwitch && typeof window !== 'undefined') {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('Make API Private')} {...field} />
                  </FormControl>
                  <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder={t('Welcome to our Make API Private...')}
                      rows={6}
                      {...field}
                    />
                  </FormControl>

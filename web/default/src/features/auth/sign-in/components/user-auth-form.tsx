  ...
  return (
    <Form {...form}>
      ...
      >
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  className='bg-background/80 border-cyan-500/10 h-11 rounded-xl backdrop-blur-sm'
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='relative'>
              ...
              <Link
                to='/forgot-password'
                className='text-muted-foreground absolute end-0 -top-0.5 text-sm font-medium hover:text-cyan-500 hover:opacity-100'
              >
                {t('Forgot password?')}
              </Link>
            </FormItem>
        ...
        <Button
          type='submit'
          className='from-primary to-primary/80 mt-2 h-11 w-full justify-center gap-2 rounded-xl bg-gradient-to-r shadow-[0_12px_30px_-12px_rgba(59,130,246,0.55)]'
        ...
        {passkeyLoginEnabled && (
          <div className='mt-2 space-y-1'>
            <Button
              ...
              className='border-cyan-500/15 bg-background/65 h-11 w-full justify-center gap-2 rounded-xl backdrop-blur-sm'
            >
              {isPasskeyLoading ? (

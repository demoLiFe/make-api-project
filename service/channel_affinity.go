...
const (
	...
	channelAffinityCacheNamespace           = "make-api-private:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "make-api-private:channel_affinity_usage_cache_stats:v1"
)
